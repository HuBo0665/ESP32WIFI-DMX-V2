...
#define TASK_STACK_SIZE 16384       // 任务堆栈大小，使用较大的值
#endif
...
#define DMX_BUFFER_SIZE 512  // 仅当未定义时才定义
#endif
...
#define CONFIG_HEAP_REPORT_INTERVAL 30000     // 堆内存报告间隔(ms)
#define CONFIG_STATUS_CHECK_INTERVAL 10000    // 状态检查间隔(ms)
